# -*- coding: utf-8 -*-
"""
Created on Mon Jun  5 14:23:32 2023
...
print('Coefficient of determination (R^2):', r2_score(y_test, y_pred))
    ...
    to describe a relationship between HDI and Health and Educatin Spending
    of Angola government.
    
    In the and we'll se how this line fits the data points, but firstly, let
...
Reg.summary()
    ...
    """
    From this summary, as we can se, the   p-value is greater than 0.05 (0.07).
